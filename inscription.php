        ...
        <div class="register-container d-flex align-items-center justify-content-center p-4">
          <div class="w-100" style="max-width: 500px;">
            <div class="text-center mb-4">
              ...
              <p class="text-muted">Créez votre compte pour accéder à la cantine</p>
            </div>
            ...
            if (isset($_POST['inscription'])) {
              // Get POST data directly for validation
              ...
              if (empty($email) || empty($password) || empty($nom) || empty($prenom) || empty($number) || empty($entreprise)) {
                echo '<div class="alert alert-danger alert-dismissible fade show" role="alert">
                                      <i class="fas fa-exclamation-circle me-2"></i>Tous les champs doivent être remplis !
                ...
                try {
                  ...
                  if ($insertisOk) {
                    ...
                    echo '<div class="alert alert-success alert-dismissible fade show" role="alert">
                                                <i class="fas fa-check-circle me-2"></i>Inscription réussie ! 
                  ...
                  echo '<div class="alert alert-danger alert-dismissible fade show" role="alert">
                                            <i class="fas fa-times-circle me-2"></i>Erreur: ' . htmlspecialchars($e->getMessage()) . '
                                            <button type="button" class="btn-close" data-bs-dismiss="alert" aria-label="Close"></button>
                                          </div>';
                }
              }
                        ...
                        <div class="mb-3">
                          ...
                          <div class="input-group">
                            ...
                            <input type="email" class="form-control" id="email" name="email"
                              placeholder="Votre email" value="<?php echo $email; ?>" required>
                          </div>
                        </div>
                      </div>
                        ...
                        <div class="mb-3">
                          ...
                          <div class="input-group">
                            ...
                            <input type="text" class="form-control" id="nom" name="nom"
                              placeholder="Votre nom" value="<?php echo $nom; ?>" required>
                          </div>
                        </div>
                      </div>
                        ...
                        <div class="mb-3">
                          ...
                          <div class="input-group">
                            ...
                            <input type="text" class="form-control" id="prenom" name="prenom"
                              placeholder="Votre prénom" value="<?php echo $prenom; ?>" required>
                          </div>
                        </div>
                      </div>
                        ...
                        <div class="mb-3">
                          ...
                          <div class="input-group">
                            ...
                            <input type="tel" class="form-control" id="number" name="number"
                              placeholder="Votre numéro" value="<?php echo $number; ?>" required>
                          </div>
                        </div>
                      </div>
                        ...
                        <div class="mb-3">
                          ...
                          <div class="input-group">
                            ...
                            <input type="text" class="form-control" id="entreprise" name="entreprise"
                              placeholder="Nom de l'entreprise" value="<?php echo $entreprise; ?>" required>
                          </div>
                        </div>
                      </div>
                        ...
                        <div class="mb-3">
                          ...
                          <div class="input-group">
                            ...
                            <input type="text" class="form-control" id="Adresse" name="Adresse"
                              placeholder="Votre adresse" value="<?php echo $Adresse; ?>" required>
                          </div>
                        </div>
                      </div>
                    </div>
